...
export const AppContextProvider = (props)=>{
    ...
    try {
        console.log("Fetching from:", backendUrl + '/api/course/all'); // ✅ Debug URL
        const { data } = await axios.get(backendUrl + '/api/course/all');
        console.log("Fetched Courses:", data); // ✅ Log data
        ...
        console.error("Error fetching all courses:", error); // ✅ Catch error
